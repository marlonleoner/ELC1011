...
#			Ex.: r 10. Este comando realiza a simulação de 10 instruções em linguagem de máquina, do endereço dado por PC
#
#		- d
#			Apresenta no terminal o conteúdo atual dos registradores. 
#			Ex. d
#
